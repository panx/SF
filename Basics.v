...
(** The first one simplifies to n+0=n. The second one simplifies to n=n. The difference is caused by the definition of the plus operation.*)
(* ###################################################################### *)
(** * The [intros] Tactic *)
...
Theorem plus_1_left: forall n: nat,
  1+n = n +1.
Proof. intros n. simpl. induction n. reflexivity. simpl. rewrite IHn. reflexivity. Qed.  



Theorem unit_test:
  forall b:bin, btou (incb b)=  (btou b)+1.
...
(* $Date: 2013-01-09 00:28:00 -0500 (Wed, 09 Jan 2013) $ *)
